...
class ESCS(Dataset):
    ...
    def __init__(self, root='./', phase='train', 
        ...
        self.all_train_df = pd.read_csv("/data2/riyansha/meta-sc_nsynth_contrastive/FCAC-contrast/data/esc10/train_esc10.csv")
        self.all_val_df = pd.read_csv("/data2/riyansha/meta-sc_nsynth_contrastive/FCAC-contrast/data/esc10/valid_esc10.csv")
        self.all_test_df = pd.read_csv("/data2/riyansha/meta-sc_nsynth_contrastive/FCAC-contrast/data/esc10/test_esc10.csv")
        with open("/data2/riyansha/meta-sc_nsynth_contrastive/FCAC-contrast/data/esc10/esc10_vocab.json") as vocab_json_file:
...
if __name__ == '__main__':
    ...
    base_class = 6 #59
    class_index = np.arange(base_class, 10)
    dataroot = "/data1/ESC-10/archive/Data/"
    batch_size_base = 400 
    print("dataroot:",dataroot)
    trainset = ESCS(root=dataroot, phase="train",  index=class_index, k=5,
                      base_sess=False)
