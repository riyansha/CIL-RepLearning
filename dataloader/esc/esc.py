...
class ESC(Dataset):
    ...
    def __init__(self, root='./', phase='train', 
        ...
        self.all_train_df = pd.read_csv("/data2/riyansha/meta-sc_nsynth_contrastive/FCAC-contrast/data/esc50/train_data.csv")
        self.all_val_df = pd.read_csv("/data2/riyansha/meta-sc_nsynth_contrastive/FCAC-contrast/data/esc50/valid_data.csv")
        self.all_test_df = pd.read_csv("/data2/riyansha/meta-sc_nsynth_contrastive/FCAC-contrast/data/esc50/test_data.csv")
        with open("/data2/riyansha/meta-sc_nsynth_contrastive/FCAC-contrast/data/esc50/esc_vocab.json") as vocab_json_file:
    ...
    def SelectfromClasses(self, df, index, per_num=None):
        ...
        for i in index:
            ...
            for j in ind_cl:
                ...
                targets_tmp.append(df['target'][j])
                # print('targets_tmp',targets_tmp)
                k += 1
...
if __name__ == '__main__':
    ...
    base_class = 30 #59
    class_index = np.arange(base_class, 50)
    dataroot = "/data1/ESC-50/archive/audio/audio/"
    batch_size_base = 400 
    print("dataroot:",dataroot)
    trainset = ESC(root=dataroot, phase="train",  index=class_index, k=5,
                      base_sess=False)
    ...
    #print("targets",trainloader.targets)
    list(trainloader)    
