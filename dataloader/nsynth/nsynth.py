...
class NDS(Dataset):
    ...
    def __init__(self, root='./', phase='train', 
        ...
        self.all_val_df = pd.read_csv(f"data/nsynth/{args.dataset}-fs-meta/{args.dataset}-fs_train.csv")
