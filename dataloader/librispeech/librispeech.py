...
class LBRS(Dataset):
    ...
    def __init__(self, root='./', phase='train', 
        ...
        self.all_train_df = pd.read_csv("data/librispeech/fscil_trainlib.csv")
        self.all_val_df = pd.read_csv("data/librispeech/fscil_vallib.csv")
        self.all_test_df = pd.read_csv("data/librispeech/fscil_testlib.csv")
...
if __name__ == '__main__':
    ...
    dataroot = "/data1/LibriSpeech_fscil/ffmpeg-6.1-amd64-static/spk_segments"
    batch_size_base = 400
