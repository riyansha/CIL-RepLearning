...
data_dir = "/data1/LibriSpeech_fscil/ffmpeg-6.1-amd64-static/train-clean-100"
spk_total_duration_json_path = "./data/librispeech/spk_total_duration.json"
output_dir = "/data1/LibriSpeech_fscil/ffmpeg-6.1-amd64-static/spk_single_audio"
...
for spk in tqdm(selected_spk_id, total=len(selected_spk_id)):
    ...
    spk_audio.export(f"/data1/LibriSpeech_fscil/ffmpeg-6.1-amd64-static/spk_single_audio/{spk}.wav", format='wav')