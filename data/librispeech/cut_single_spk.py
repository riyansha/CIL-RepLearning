...
single_spk_dir = "/data1/LibriSpeech_fscil/ffmpeg-6.1-amd64-static/spk_single_audio"
spk_segment_dir = "/data1/LibriSpeech_fscil/ffmpeg-6.1-amd64-static/spk_segments"
train_csv_path = "./data/librispeech/fscil_trainlib.csv"
val_csv_path = "./data/librispeech/fscil_vallib.csv"
test_csv_path = "./data/librispeech/fscil_testlib.csv"
spk_mapping_path = "./data/librispeech/mapping_of_speakers.json"
