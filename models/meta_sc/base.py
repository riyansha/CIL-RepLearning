...
class Trainer(object, metaclass=abc.ABCMeta):
    ...
    def set_up_datasets(self):
        if self.args.dataset == 'nsynth-100':
        ...
        elif self.args.dataset == 'esc':
            import dataloader.esc.esc as Dataset
        elif self.args.dataset == 'pqrs':
            import dataloader.esc10.esc10 as Dataset
